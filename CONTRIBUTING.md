# Contributing to Akka Persistence Spanner 
...
4. When the feature or fix is completed you should open a [Pull Request](https://help.github.com/articles/using-pull-requests) on [GitHub](https://github.com/akka/akka-persistence-spanner/pulls).
...
1. [Travis CI](https://travis-ci.org/akka/akka-persistence-spanner) automatically merges the code, builds it, runs the tests and sets Pull Request status accordingly of results in GitHub.
