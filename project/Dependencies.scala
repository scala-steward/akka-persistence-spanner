...
object Dependencies {
  ...
  object Compile {
    ...
    val logback = "ch.qos.logback" % "logback-classic" % "1.2.11" // EPL 1.0 / LGPL 2.1
  }
  ...
  object TestDeps {
    ...
    val junitInterface = "com.github.sbt" % "junit-interface" % "0.13.3" % Test // "BSD 2-Clause"
  }
